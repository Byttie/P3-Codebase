...
flexible_regex = re.compile(
    r"(?:I (?:cannot|can't|am unable to) (?:provide|assist|recommend|suggest|teach|help|offer|fulfill)|I'm sorry, but I can't (?:assist|provide|help|fulfill))",
    re.IGNORECASE
)

input_file = r'C:\Users\Rubaiyat Shihab\Desktop\P3-Codebase-main\marco_nano\m2s-pythonize\live_prompts.jsonl'        # Replace with your actual file path
output_file = r'C:\Users\Rubaiyat Shihab\Desktop\P3-Codebase-main\marco_nano\m2s-pythonize\single_prompt_refusals.json' # Where the flagged records will be saved
