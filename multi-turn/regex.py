...
refusal_regex = re.compile(
    r"(?:I (?:cannot|can['’]t) (?:provide|assist|recommend|suggest|guide|teach|help|offer|fulfill|advise)|I['’]m sorry(?:[^,.]+)?(?:,|.) but I can['’]t (?:assist|provide|help|recommend|fulfill))",
    re.IGNORECASE
)

input_file = r'C:\Users\Rubaiyat Shihab\Desktop\P3-Codebase-main\marco_nano\multi-turn\live_turns.jsonl'           # Replace with your actual input file name
output_file = r'C:\Users\Rubaiyat Shihab\Desktop\P3-Codebase-main\marco_nano\multi-turn\flagged_refusals.json' # Where the flagged records will be saved
